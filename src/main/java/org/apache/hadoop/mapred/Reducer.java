 ...
 * values.  Input values are the grouped output of a {@link org.apache.hadoop.mapred.Mapper}. */
public interface Reducer extends JobConfigurable, Closeable {
   ...
   * calls to {@link OutputCollector#collect(org.apache.hadoop.io.WritableComparable, org.apache.hadoop.io.Writable)}.
   *
   * @param key the key
