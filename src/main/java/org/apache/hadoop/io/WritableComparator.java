...
/** A Comparator for {@link org.apache.hadoop.io.WritableComparable}s.
 *
 * <p>This base implemenation uses the natural ordering.  To define alternate
 * orderings, override {@link #compare(org.apache.hadoop.io.WritableComparable, org.apache.hadoop.io.WritableComparable)}.
 *
...
public class WritableComparator implements Comparator {
  ...
  /** Get a comparator for a {@link org.apache.hadoop.io.WritableComparable} implementation. */
  ...
  /** Register an optimized comparator for a {@link org.apache.hadoop.io.WritableComparable}
   * implementation. */
  ...
  /** Construct for a {@link org.apache.hadoop.io.WritableComparable} implementation. */
  ...
  /** Construct a new {@link org.apache.hadoop.io.WritableComparable} instance. */
   ...
   * org.apache.hadoop.io.WritableComparable}s (using {@link
   * org.apache.hadoop.io.Writable#readFields(java.io.DataInput)}, then calls {@link
